...
const mockedGetOnlineShopDetails = getOnlineShopDetails as MockedFunction<
  typeof getOnlineShopDetails
>;
...
describe("getOnlineShopDetails", () => {
  ...
  it("should throw an error if the fetch fails", async () => {
    ...
    await expect(getOnlineShopDetails("1")).rejects.toThrow(
      "Failed to fetch product details for id: 1",
    );
  });
});
